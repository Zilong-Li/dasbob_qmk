...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [BASE] = LAYOUT_split_3x5_3(
            ...
            KC_A,   LALT_T(KC_S), LCTL_T(KC_D), LGUI_T(KC_F), LSFT_T(KC_G),              LSFT_T(KC_H), LGUI_T(KC_J), LCTL_T(KC_K),   LALT_T(KC_L), KC_SCLN,
    ...
    [MEDIA] = LAYOUT_split_3x5_3(
            ...
            KC_NO,          KC_LALT,      KC_LCTL,      KC_LGUI,      KC_LSFT,           RGB_VAI,      KC_MPRV,      KC_VOLD,        KC_VOLU,      KC_MNXT,
    ...
    [NAVIGATION] = LAYOUT_split_3x5_3(
            ...
            KC_NO,          KC_LALT,      KC_LCTL,      KC_LGUI,      KC_LSFT,           KC_LEFT,      KC_DOWN,      KC_UP,          KC_RIGHT,     KC_CAPS, 
    ...
    [MOUSE] = LAYOUT_split_3x5_3(
            KC_NO,          KC_NO,        KC_NO,        KC_NO,        KC_NO,             KC_AGIN,      KC_PSTE,      KC_COPY,        KC_CUT,       KC_UNDO,
            KC_NO,          KC_LALT,      KC_LCTL,      KC_LGUI,      KC_LSFT,           KC_MS_L,      KC_MS_D,      KC_MS_U,        KC_MS_R,      KC_NO, 
    ...
    [SYMBOLS] = LAYOUT_split_3x5_3(
            ...
            LSFT(KC_QUOTE), LSFT(KC_4),   LSFT(KC_5),   LSFT(KC_6),   LSFT(KC_EQL),      KC_LSFT,      KC_LGUI,      KC_LCTL,        KC_LALT,      KC_NO,
    ...
    [NUMBERS] = LAYOUT_split_3x5_3(
            ...
            KC_QUOTE,       KC_4,         KC_5,         KC_6,         KC_EQUAL,          KC_LSFT,      KC_LGUI,      KC_LCTL,        KC_LALT,      KC_NO,
    ...
    [FUNCTIONS] = LAYOUT_split_3x5_3(
            ...
            KC_F11,         KC_F4,        KC_F5,        KC_F6,        KC_SCRL,           KC_LSFT,      KC_LGUI,      KC_LCTL,        KC_LALT,      KC_NO,
